...
| [**Concept: Assistant Family, Assistant, and Agent**](sessions/assistants_agents.md) | See how an AI assistant (Claude Desktop, CLI, Codex) hosts agents that loop with an LLM and its tools to get work done. | 30 mins | [Claude Chat](miscellaneous/tools/claude/desktop.md) |  |
