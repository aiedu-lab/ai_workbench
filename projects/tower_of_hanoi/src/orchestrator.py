...
class Orchestrator:
    ...
    Args:
        ...
        step_file    (str):  Path to the Markdown output file; passed to StepWriter.
    """
    ...
    def get_towers(self) -> list[Tower]:
        """Return the three Tower objects (useful for testing mid-run state)."""
        raise NotImplementedError

    def get_move(self) -> Move:
        """Return the Move object (useful for inspecting step count in tests)."""
        raise NotImplementedError
