...
### Exercise
- Exercise 1: How credit card works?
  ...
  - [Negative Prompt](../prompts/best.md#Prompting#CreditCard#NegativePrompt)
    - removes jargon and enforces discipline
    - tighter output
  - [Failure Injection Prompt](../prompts/failures.md#Prompting#CreditCard)
    - confusing output and tone
    - violates audience and length constraint 
    - conflicting constraint => bad output
- Exercise 2: Rewrites to improve content
...
### Output
- [Notes](../learnings/session-notes/prompting.md)
- Prompts:
  - [Best](../prompts/best.md#Prompting)
  - [Poor](../prompts/poor.md#Prompting)
  - [Failures](../prompts/failures.md#Prompting)