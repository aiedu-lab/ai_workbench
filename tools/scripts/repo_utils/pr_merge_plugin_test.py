...
merge_pr.py (verified via --help and real-but-safe invocations, plus
the live PR #70/#71 validation against ai_workbench's actual
required-review-except-admin branch protection).
"""
