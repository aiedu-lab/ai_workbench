...
class SkillBuildAndTestTest(unittest.TestCase):
  """ai_workbench's skill_build_and_test is a STUB (no container_tests
  / dockerfile_container_tests targets exist yet -- see the
  function's own docstring), so it only ever runs the 2 bazel
