...
Ported from ../aim's version of this file. Targets a stub
`.github/workflows/pr-validation.yaml` -- this repo has no real
CI gate yet (see README.md's "How to Make Changes" TODO).
